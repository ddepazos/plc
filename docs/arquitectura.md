...
| --- | --- | --- |
| Node sin paquetes externos | Inicio reproducible sin instalación de dependencias | Router HTTP pequeño, a mantener con pruebas |
